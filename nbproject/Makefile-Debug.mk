...
${OBJECTDIR}/ArrayRankDouble.o: ArrayRankDouble.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ArrayRankDouble.o ArrayRankDouble.cpp
...
${OBJECTDIR}/FingerprintProperties.o: FingerprintProperties.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FingerprintProperties.o FingerprintProperties.cpp

${OBJECTDIR}/IntensityProcessor.o: IntensityProcessor.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IntensityProcessor.o IntensityProcessor.cpp

${OBJECTDIR}/Resampler.o: Resampler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Resampler.o Resampler.cpp

${OBJECTDIR}/Spectogram.o: Spectogram.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Spectogram.o Spectogram.cpp

${OBJECTDIR}/TopManyPointsProcessorChain.o: TopManyPointsProcessorChain.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TopManyPointsProcessorChain.o TopManyPointsProcessorChain.cpp

${OBJECTDIR}/Wave.o: Wave.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Wave.o Wave.cpp

${OBJECTDIR}/WaveHeader.o: WaveHeader.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/WaveHeader.o WaveHeader.cpp

${OBJECTDIR}/WindowFunction.o: WindowFunction.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/WindowFunction.o WindowFunction.cpp
