 ...
 * Author: antwalls
 * 
 * Created on 17 de marzo de 2015, 16:11
 */
...
FFT::FFT(int fftFrameSize, int sign) 
{
    ...
    bitm_array = vector<int>[fftFrameSize2];
...
void FFT::transform(vector<double> data) 
{
    bitreversal(data);
    calc(fftFrameSize, data, sign, w);
}

static vector<double> FFT::computeTwiddleFactors(int fftFrameSize,int sign) 
{
    int imax = (int) (log(fftFrameSize) / log(2.));

    vector<double> warray = vector<double>((fftFrameSize - 1) * 4);
    int w_index = 0;
...
static void FFT::calc(int fftFrameSize, vector<double> data, int sign,vector<double> w) 
{
 ...
 static void FFT::calcF2E(int fftFrameSize, vector<double> data, int i,int nstep, vector<double> w) {
    int jmax = nstep;
...
// complex operators
 static void FFT::calcF4F(int fftFrameSize, vector<double> data, int i,int nstep, vector<double> w) {
...
// Perform Factor-4 Decomposition with 3 * complex operators and 8 +/-
// complex operators
 static void FFT::calcF4I(int fftFrameSize, vector<double> data, int i,int nstep, vector<double> w) {
    int fftFrameSize2 = fftFrameSize << 1; // 2*fftFrameSize;
    // Factor-4 Decomposition
...
// Perform Factor-4 Decomposition with 3 * complex operators and 8 +/-
// complex operators
 static void FFT::calcF4FE(int fftFrameSize, vector<double> data, int i,int nstep, vector<double> w) {
    int fftFrameSize2 = fftFrameSize << 1; // 2*fftFrameSize;
    // Factor-4 Decomposition
...
// Perform Factor-4 Decomposition with 3 * complex operators and 8 +/-
// complex operators
 static void FFT::calcF4IE(int fftFrameSize, vector<double> data, int i,int nstep, vector<double> w) {
    int fftFrameSize2 = fftFrameSize << 1; // 2*fftFrameSize;
    // Factor-4 Decomposition
 ...
 void FFT::bitreversal(vector<double> data) {
    if (fftFrameSize < 4)
        return;
